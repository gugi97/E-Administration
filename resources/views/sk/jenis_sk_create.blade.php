...
@section('content')
    ...
    <section class="content" style="min-height: 1135px;">
            ...
            <script>
                ...
                CKEDITOR.instances['templatesk'].setData('<img src="{{asset('kop_surat.png')}}" width="100%"><b><h3 style="text-align:center;">NOMOR SURAT : [Field Nomor Surat]</h3></b><h3 style="text-align:center;">TENTANG : </h3><b><h3 style="text-align:center">[Tentang Surat]</h3></b><p style="text-align:center">[ISI SURAT]</p><p style="text-align:center;">KAMPUS ROXY MAS : Pusat Niaga Roxy Mas Blok E.2 No. 38-39 Telp: (021) 6328709, 6328710, Fax: (O21) 6322872<br>KAMPUS SALEMBA MAS : Sentra Salemba Mas Blok S-T, Telp:(021) 3928688, 3928689, Fax:(021) 3161636</p>');
            </script>
    </section>
{{-- End Add Modal --}}
@endsection
