    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                @if($orders != null)
                    <h3 class="card-title"><a href="/agendasuratkeluar" class="btn btn-primary"><i class="fas fa-sync-alt"></i> Refresh Data</a></h3>
                @endif
                    <h3 align="center">Buku Agenda Surat Keluar</h3>
                </div>
                <!-- End Card Header -->
                <!-- form start -->
                <form role="form" method="get" action="{{url('agendasuratkeluar/pencarian')}}">
                    @if($orders == null)
