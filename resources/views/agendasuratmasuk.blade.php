            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item active">Buku Agenda Surat Masuk</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                @if($orders != null)
                    <h3 class="card-title"><a href="/agendasuratmasuk" class="btn btn-primary"><i class="fas fa-sync-alt"></i> Refresh Data</a></h3>
                @endif
                    <h3 align="center">Buku Agenda Surat Masuk</h3>
                </div>
                <!-- End Card Header -->
                <!-- form start -->
                <form role="form" method="get" action="{{url('agendasuratmasuk/pencarian')}}">
                    @if($orders == null)
                ...
                <form role="form" method="get" action="{{url('agendasuratmasuk_pdf')}}" align='center'>
